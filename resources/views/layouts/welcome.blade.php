                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <div class="px-3 py-2 border-bottom">
                                        <small class="text-muted">Signed in as {{ $isAdmin ? 'Admin' : 'User' }}</small>
                                    ...
                                    @else
                                        {{ redirect()->route('logout')->with('error', 'You do not have access to this page.') }}
                                    @endif

                                    <a class="dropdown-item" href="{{ $isAdmin ? route('admin.profile.show') : route('profile.show') }}">
                                    ...
                                    <a class="dropdown-item text-danger" href="{{ $isAdmin ? route('admin.logout') : route('logout') }}"
